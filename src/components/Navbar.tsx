        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 h-13 sm:h-14 flex items-center justify-between gap-2 sm:gap-4 overflow-visible">
          ...
          <div className="hidden md:flex items-center gap-5 shrink-0">
            ...
            <a
              ...
              title="Follow @majhboisar on Instagram"
              className="flex flex-col items-center justify-center text-slate-500 hover:text-pink-600 transition-colors group cursor-pointer"
            >
              <div className="w-5 h-5 flex items-center justify-center">
                <svg className="w-4 h-4 fill-current text-slate-400 group-hover:text-pink-600 transition-colors" viewBox="0 0 24 24">
              ...
              <span className="text-[10px] font-bold mt-1 text-slate-500 group-hover:text-pink-600 transition-colors leading-none">Insta</span>
            </a>
