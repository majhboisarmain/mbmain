        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4 shrink-0 pr-10 border-b border-slate-100 pb-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-base sm:text-lg font-black text-slate-900 leading-tight">
                Boisar MIDC Events &amp; Job Fairs
              </h3>
              <p className="text-xs text-slate-500 font-bold">
                Upcoming industrial job drives, blood donation camps, and community notices in Boisar
              </p>
            </div>
          </div>
          ...
          {!showAddForm && (
            <button 
              ...
              className="bg-indigo-600 hover:bg-indigo-700 active:scale-95 text-white font-black text-xs px-3.5 py-2 rounded-xl transition-all cursor-pointer shadow-2xs shrink-0 flex items-center gap-1.5 self-start sm:self-auto"
            >
              <Plus className="w-4 h-4" />
              <span>{isLoggedIn ? '+ Submit Event / Notice' : '🔒 Login to Submit'}</span>
            </button>
          )}
        </div>
