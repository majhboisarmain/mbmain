  ...
  return (
    <div className="bg-[#f8fafc] min-h-screen pb-16 text-slate-800 font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-4 sm:mt-5">
        ...
        <div 
          className="relative border border-slate-200 rounded-3xl p-4 sm:p-6 shadow-sm bg-white overflow-hidden text-left bg-no-repeat bg-cover bg-right-bottom sm:bg-center"
          style={{
        ...
        >
          ...
          <div className="absolute inset-0 bg-white/60 sm:bg-white/40 pointer-events-none" />

          {/* Heart / Bookmark Button Absolute */}
          <button
            onClick={handleToggleFavorite}
            className={`absolute top-4 right-4 p-2.5 rounded-2xl border transition-all cursor-pointer shadow-2xs z-10 ${isFavorite
                ? 'bg-rose-50 border-rose-200 text-rose-600'
                : 'bg-white/90 hover:bg-white border-slate-200 text-slate-400 hover:text-rose-500'
              }`}
            title={isFavorite ? "Remove Bookmark" : "Bookmark Shop"}
          >
          ...
          <div className="flex flex-col gap-4 relative z-10">
            ...
            {/* Top row: Avatar Image (Bigger) + Title Details */}
            <div className="flex flex-row items-start gap-3.5 sm:gap-6 w-full">
              {business.image ? (
                <div
                  onClick={() => setLightboxIndex(0)}
                  className="w-24 h-24 sm:w-36 sm:h-36 shrink-0 rounded-2xl overflow-hidden border border-slate-200 shadow-sm bg-slate-50 cursor-pointer hover:opacity-90 transition-opacity relative flex items-center justify-center"
                ...
                <div className="w-24 h-24 sm:w-36 sm:h-36 shrink-0 rounded-2xl overflow-hidden border border-slate-200 shadow-sm bg-teal-50 flex flex-col items-center justify-center">
                  <Building2 className="w-10 h-10 sm:w-12 sm:h-12 text-teal-300 mb-1" />
                  <span className="text-[10px] font-bold text-teal-500">No Image</span>
                </div>
              )}

              <div className="space-y-1.5 sm:space-y-2 text-left pt-0.5 w-full min-w-0 pr-10 sm:pr-0">

                {/* Badges */}
                <div className="flex flex-wrap items-center gap-1.5">
                  <span className="bg-teal-50 border border-teal-200 text-teal-800 text-[10px] font-black uppercase px-2.5 py-0.5 rounded-md">
                    {business.category}
                  </span>
                  {((business as any).subscription === 'Admin Created' || (business as any).createdBy === 'Admin' || (business as any).postedBy === 'Admin' || (business.description && business.description.includes('[Created by Admin]'))) && (
                    <span className="bg-gradient-to-r from-amber-500 to-amber-600 text-white text-[10px] font-black uppercase px-2.5 py-0.5 rounded-md flex items-center gap-1 shadow-xs border border-amber-300">
                      <span>👑 Created by Admin</span>
                    </span>
                  )}
                  {business.verified && (
                    <span className="bg-emerald-50 border border-emerald-200 text-emerald-700 text-[10px] font-black uppercase px-2 py-0.5 rounded-md flex items-center gap-1">
                ...
                {/* Name */}
                <h1 className="text-lg sm:text-2xl lg:text-3xl font-black text-slate-900 tracking-tight leading-snug">
                  {business.name}
                </h1>

                {/* Ratings and Location */}
                <div className="flex flex-wrap items-center gap-2 text-xs text-slate-600 font-semibold">
                  <div className="inline-flex items-center gap-1 bg-emerald-600 text-white text-[11px] font-black px-2 py-0.5 rounded-lg shadow-2xs">
                    <span>{business.rating}</span>
                    <Star className="w-3 h-3 fill-white text-white" />
                  </div>
                  <span className="text-slate-500 font-bold hover:underline cursor-pointer">
                  ...
                  {business.googleMaps ? (
                    <a
                      ...
                      className="text-teal-700 hover:text-teal-800 font-bold flex items-center gap-1 hover:underline cursor-pointer truncate max-w-[180px] sm:max-w-none"
                    >
            ...
            <div className="flex flex-col gap-3 pt-3 border-t border-slate-100">
              ...
              <div className="grid grid-cols-3 sm:flex sm:items-center gap-2 sm:gap-3 w-full">
                <a
                  ...
                  className="px-3 sm:px-6 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 active:scale-95 text-white font-black text-xs flex items-center justify-center gap-1.5 sm:gap-2 transition-all shadow-xs cursor-pointer"
                >
                ...
                <a
                  ...
                  className="px-3 sm:px-6 py-2.5 rounded-xl bg-emerald-50 hover:bg-emerald-100/80 border border-emerald-300 text-emerald-800 font-black text-xs flex items-center justify-center gap-1.5 sm:gap-2 transition-all cursor-pointer"
                >
