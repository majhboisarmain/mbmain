...
export default function BusinessDetailClient({ initialBusiness }: { initialBusiness?: any }) {
...
_Order submitted via MajhBoisar.in_`;
  ...
  const handleShare = async () => {
    if (typeof window !== 'undefined' && business) {
      ...
      const shareText = `🌟 *${business.name} (Boisar)*\n📍 Location: ${business.location || 'Boisar'}, Palghar\n⭐ Rating: ${business.rating || 4.8} / 5 (${business.reviewCount || 12}+ Reviews)\n📞 Phone: ${business.phone}\n${business.workingHours ? `⏰ Timing: ${business.workingHours}\n` : ''}\n👉 View Full Profile, Photos & Menu on Majh Boisar:\n${shareUrl}`;
      ...
      try {
        ...
        setCopiedLink(true);
        showToast('Profile & Details copied! Ready to paste in WhatsApp 📋', 'success');
