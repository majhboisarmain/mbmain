        ...
        <LanguageProvider>
          <AppProvider>
            ...
            <div className="w-full min-h-screen flex flex-col relative">
              ...
              <footer className="border-t border-slate-200/80 bg-slate-50/60 py-6 text-slate-600 text-xs shrink-0">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-4 text-center">
                  {/* Primary Navigation Links */}
                  <nav aria-label="Footer Navigation" className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs font-medium text-slate-600">
                    <a href="/" className="hover:text-teal-700 transition-colors">Home</a>
                    <a href="/hotels" className="hover:text-teal-700 transition-colors">Hotels</a>
                    <a href="/properties" className="hover:text-teal-700 transition-colors">Properties</a>
                    <a href="/services" className="hover:text-teal-700 transition-colors">Home Services</a>
                    <a href="/jobs" className="hover:text-teal-700 transition-colors">Jobs</a>
                    <a href="/hire-vehicle" className="hover:text-teal-700 transition-colors">Travels</a>
                    <a href="/resorts" className="hover:text-teal-700 transition-colors">Resorts</a>
                    <a href="/blood-donation" className="hover:text-teal-700 transition-colors">Blood Donors</a>
                  </nav>

                  {/* Secondary Links & Instagram */}
                  <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-[11px] text-slate-500 pt-3 border-t border-slate-200/60">
                    <a href="/advertise" className="hover:text-teal-700 transition-colors">Advertise</a>
                    <span>•</span>
                    <a href="mailto:majhboisar@gmail.com" className="hover:text-teal-700 transition-colors">Help &amp; Support</a>
                    <span>•</span>
                    <a href="/privacy" className="hover:text-teal-700 transition-colors">Privacy</a>
                    <span>•</span>
                    <a href="/terms" className="hover:text-teal-700 transition-colors">Terms</a>
                    <span>•</span>
                    <a 
                      href="https://instagram.com/majhboisar" 
                      target="_blank" 
                      rel="noopener noreferrer" 
                      className="inline-flex items-center gap-1 text-pink-600 hover:text-pink-700 font-semibold transition-colors"
                    >
                      ...
                      <span>@majhboisar</span>
                    </a>
                  </div>

                  {/* Copyright & Credit */}
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-1.5 pt-2 border-t border-slate-200/40 text-[10px] text-slate-400">
                    <p>© 2026 Majh Boisar. All rights reserved.</p>
                    <p>
                      Developed by <a href="https://buildlabs.in" target="_blank" rel="noopener noreferrer" className="text-slate-500 font-medium hover:text-teal-700 transition-colors">buildlabs.in</a>
                    </p>
                  </div>
                </div>
              </footer>
