  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans pb-20">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 mt-2 sm:mt-3">
        ...
        {/* If no hotels listed: Display Minimal Property Sold-Out Style Coming Soon Cards */}
        {filteredAndSortedHotels.length === 0 ? (
          <div className="space-y-3.5 my-2 text-left">
            {[
              { id: 'cs-hotel-1', tag: 'BOISAR WEST', area: 'Boisar West' },
              { id: 'cs-hotel-2', tag: 'TARAPUR MIDC', area: 'Tarapur MIDC' },
              { id: 'cs-hotel-3', tag: 'STATION ROAD', area: 'Station Road, Boisar' }
            ].map(item => (
              <div
                key={item.id}
                ...
                <div className="flex flex-col sm:flex-row gap-3.5 sm:gap-5 items-center">
                  ...
                  <div className="relative w-full sm:w-[220px] md:w-[250px] h-[130px] sm:h-[140px] rounded-xl sm:rounded-2xl overflow-hidden bg-slate-900 shrink-0 select-none pointer-events-none">
                    <div className="w-full h-full bg-gradient-to-br from-slate-900 via-slate-800 to-slate-950 flex flex-col items-center justify-center p-3 text-center">
                      <Building2 className="w-10 h-10 text-slate-700/60 mb-1" />
                      <span className="text-[9.5px] font-bold text-slate-500 uppercase tracking-widest">Boisar Stays</span>
                    </div>
